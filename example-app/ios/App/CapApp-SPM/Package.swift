...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapgoCapacitorPersistentAccount", path: "../../../node_modules/.bun/@capgo+capacitor-persistent-account@file+../node_modules/@capgo/capacitor-persistent-account")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
